...
toggle_restarter:
IfExist, C:\Users\*USERID*\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Restarter_1.6.exe
	{
		send {ctrl down}q{ctrl up}
		FileDelete, C:\Users\*USERID*\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Restarter_1.6.exe
	}
	else
	{
		FileCopy, M:\Restarter_1.6.exe, C:\Users\*USERID*\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup
		run C:\Users\*USERID*\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup\Restarter_1.6.exe
	}
return
