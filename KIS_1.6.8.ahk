...
Gui, Add, text,, Install Bluezone`, PDF Factory`, DB2`, oracle x86 and x64
Gui, Add, button, gBPDO_install, Install the&m all
...
Gui, Add, Button, gPolicyReset, MP mulli&gan
...
Gui, Add, button, gsccm, Soft&ware Center
Gui, Add, button, gMALL, S&oftware Mall
Gui, Add, text,, Check Patches
Gui, Add, button, gpatch_report, Run &Patch report
...
;run patchreport.vbs
patch_report:
run \\pfgfsent01\enterprise\ISWorkstationManagement\ClientTeamPatches\SCCM\PatchReport.vbs
return
...
Install850driver:
run "Intel Video Drive 20.19.15.4457-May-2016-sp76114.exe", R:\DTSUtils\Drivers\Laptop-Desktop Drivers\850 G3 Drivers
...
MALL:
run R:\W7Utils\PFGInstallMenu.exe
return
